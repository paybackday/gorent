                    ...
                    <form action="../gorenting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_facebook" value="<?php echo $ayarcek['ayar_facebook'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_twitter" value="<?php echo $ayarcek['ayar_twitter'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_instagram" value="<?php echo $ayarcek['ayar_instagram'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_youtube" value="<?php echo $ayarcek['ayar_youtube'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
