                    ...
                    <form action="../gorenting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_analytics" value="<?php echo $ayarcek['ayar_analytics'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_maps" value="<?php echo $ayarcek['ayar_maps'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_zopim" value="<?php echo $ayarcek['ayar_zopim'] ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
